              ...
              <Table>
                <TableHeader className="sticky top-0 bg-background z-10">
                  <TableRow>
                    ...
                    <TableHead className="min-w-[200px]">p_name[de] (Original)</TableHead>
                    <TableHead className="min-w-[250px]">p_name[de]</TableHead>
                    <TableHead className="min-w-[500px]">p_description[de]</TableHead>
                    <TableHead className="min-w-[400px]">p_description[de] (Original CSV)</TableHead>
                    <TableHead className="min-w-[250px]">p_name[nl]</TableHead>
                    <TableHead className="min-w-[400px]">p_description[nl] (Text)</TableHead>
                    <TableHead className="min-w-[500px]">p_description[nl]</TableHead>
