...
const CATEGORY_TEXT_BLOCKS: Record<ProductCategory, Record<'A' | 'B' | 'C' | 'D', CategoryTextBlocks>> = {
  ...
  FUNKAKKU: {
    A: {
      absatz1: 'Dieser Akku wurde für den Einsatz in professionellen Funkgeräten entwickelt und liefert konstante Leistung über den gesamten Arbeitstag.',
      absatz2: 'Die Zelltechnologie ist auf hohe Entladeströme und viele Ladezyklen ausgelegt. Auch bei intensiver Nutzung bleibt die Kapazität lange erhalten.',
      ...
      usps: [
        'Konzipiert für professionellen Funkbetrieb',
        'Konstante Leistung für den gesamten Arbeitstag',
        'Direkter Austausch gegen den Originalakku',
        'Passgenau für gängige Funkgerätemodelle',
      ],
    },
    B: {
      absatz1: 'Für den anspruchsvollen Einsatz im Schichtdienst und Dauerbetrieb entwickelt. Der Akku hält auch bei intensiver Nutzung zuverlässig durch.',
      absatz2: 'Die robuste Zelltechnologie verkraftet häufiges Laden und Entladen ohne Leistungsverlust. Optimal für den täglichen Einsatz im Betriebsfunk.',
      absatz3: 'Der Einbau erfolgt werkzeuglos durch einfaches Einrasten. Vor der ersten Nutzung vollständig laden.',
      usps: [
        'Entwickelt für Schichtdienst und Dauereinsatz',
        'Langlebige Zellen für maximale Einsatzzeit',
        'Passgenauer Austausch ohne Anpassungen',
        'Robuste Ausführung für den harten Arbeitsalltag',
      ],
    },
    C: {
      absatz1: 'Der perfekte Ersatz für verbrauchte Funkakkus. Mit diesem Akku sind Ihre Funkgeräte wieder voll einsatzfähig.',
      absatz2: 'Ein frischer Akku verlängert die Einsatzzeit deutlich und macht Ladepausen im Außendienst seltener nötig.',
    ...
    D: {
      absatz1: 'Ersatzakku für Funkgeräte. Passend und sofort einsatzbereit.',
      absatz2: 'Langlebig und leistungsstark. Viele Ladezyklen bei gleichbleibender Kapazität.',
